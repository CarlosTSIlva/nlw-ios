...
class PlaceTableViewCell: UITableViewCell {
    ...
    private func setupConstrains() {
        NSLayoutConstraint.activate([
            ...
            ticketLabel.topAnchor.constraint(equalTo: descriptionLabel.topAnchor, constant: 8),
            ticketLabel.centerYAnchor.constraint(equalTo: ticketIcon.centerYAnchor),
            ticketLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: 4),
        ])
    }
